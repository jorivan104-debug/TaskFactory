...
**Date:** 2026-05-06
**Aligned with:** Roadmap del proyecto.md (Fase 1 gate criteria)
...
- [ ] Create a new work site and warehouse
- [ ] Update work site name
- [ ] Verify audit log captures user creation

### 2. Production Planning
- [ ] Create a development manually
- [ ] Simulate Lexi webhook creating a development
- [ ] Approve development and verify production order creation
- [ ] Create production plan with garment reference

### 3. Production Operations (Core)
- [ ] Create production order (development type)
- [ ] Create production order (batch production type)
- [ ] Add garment reference with brand, silhouette, fabric, color
- [ ] Configure size curve (3+ sizes)
- [ ] Create work orders under production order
- [ ] Update work order status through flow (pending → in_progress → completed)
- [ ] Verify time registration on work order logs
- [ ] Close production order via last-phase specialist
