...
- [ ] Definir y documentar arquitectura (frontend, backend, base de datos, integraciones)
- [ ] Modelo de datos relacional: producción, inventario, personal, finanzas **y** plantas/almacenes
...
- [ ] Listado de **entidades de dominio** mínimas y relación PT / semielaborado / insumo (pendiente en cuestionario; ver `Pregutas de la AI.md` preg. 19–20). **Borrador de tablas:** `Estructura de base de datos.md`
...
- [ ] Control de accesos coherente con roles del negocio
- [ ] Configuración general (incl. **plantas de trabajo** y **almacenes** ilimitados en modelo operativo)

### 2. Planificación de producción

- [ ] Integración con Lexi (recepción de desarrollos / solicitudes)
- [ ] Creación y gestión de planes de producción
- [ ] Programación de órdenes de producción (con contexto de planta/almacén según diseño)

### 3. Gestión operativa de producción (core)

- [ ] Creación y seguimiento de órdenes de producción
- [ ] Control de fases y estados
- [ ] Registro de tiempos por proceso
- [ ] Trazabilidad en tiempo real del estado de cada orden
...
- [ ] Asignación de tareas por operario en el flujo productivo
